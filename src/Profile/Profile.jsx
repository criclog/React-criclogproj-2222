...
export const Profile = () => {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-black opacity-95 font-serif">
      <img src={profile} className="w-full h-screen absolute -z-10 opacity-20 object-cover" alt="background" />
      <div className="min-w-100vw h-screen flex flex-col justify-center gap-14">
