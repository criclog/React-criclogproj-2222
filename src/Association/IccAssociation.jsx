...
import c1 from "../Assests/association/c1.png";
import c2 from "../Assests/association/c2.png";
import c3 from "../Assests/association/c3.png";
import c4 from "../Assests/association/c4.jpg";
import c5 from "../Assests/association/c5r.jpeg";
import c6 from "../Assests/association/c7.jpeg";
import c7 from "../Assests/association/c8.png";
import c8 from "../Assests/association/c9.jpg";
...
export const Cardteam1 = () => {
  const Card1s = [
    {
      image: c1,
      company: "Malta Cricket Association",
      place: "Europe",
    },
    {
      image: c2,
      company: "Cricket association of Nepal",
      place: "Asia",
    },
    {
      image: c3,
      company: "Hellenic Cricket Federation",
      place: "Europe",
    },
    {
      image: c4,
      company: "Cricket Sierra Leone",
      place: "Africa",
    },
    {
      image: c5,
      company: "Sri Lanka Cricket Scorers ",
      place: "Asia",
    },
    {
      image: c6,
      company: "Cricket Hong Kong",
      place: "Asia",
    },
    {
      image: c8,
      company: "Zimbabwe Cricket",
      place: "Africa",
    },
    {
      image: c7,
      company: "Seychelles Cricket Association",
      place: " Africa",
    },
  ];
  ...
  return (
    <div className="min-w-[100vh] bg-white font-serif flex justify-center items-center">
        ...
        <div className="min-w-[100vh] grid grid-cols-1 gap-4 py-5 px-4  ">
          {selectedCountry ? (
            [...Array(1)].map((i) => (
              <div key={i}
                className="w-[200px] h-[150px] bg-gray-200 shadow rounded-lg flex items-center justify-center text-gray-500 "
              >Data Not Found</div>
            ))
          ) : (
            <div className="min-w-[100vh]">
              <div className="w-[100%] grid grid-cols-1 gap-4 sm:grid-cols-1  md:grid-cols-1 lg:grid-cols-2 ">
                {Card1s.map((card, id) => (
                  <div
                    key={id}
                    className="w-[80%] h-[100px] bg-white flex rounded-md gap-2 border border-gray-400 shadow shadow-gray-400 cursor-pointer sm:w-[85%] md:w-[90%] lg:w-[100%] xl:w-[100%] mx-[10%]  md:mx-[15%] sm:mx-[15%] lg:mx-auto"
                  >
                    <img
                      src={card.image}
                      alt=""
...
export const Select1=()=> {
  ...
  return (
    <div className="w-full font-serif">
      <div className="w-[100%] bg-white  text-right flex">
        <div className="w-[40%] px-7 py-[30px] mx-[30%] md:mx-[30%] sm:mx-[30%]  ">
          <select
            className="w-full px-3 py-3 rounded-lg text-gray-500 bg-gray-200 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#4A2EB0] "
          ...
          >
            ...
            {buttons.map((button, index) => (
              <option key={index} value={button.path}>
                {button.label}
              </option>
            ))}
          </select>
