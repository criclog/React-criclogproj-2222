    ...
    <div>
      ...
      <div className="px-4 md:px-6 lg:px-20">
        ...
        {[{ img: "https://cricheroes-media-mumbai.s3.ap-south-1.amazonaws.com/server_images/your_web_landing/own-your-brand-updated.png?width=750&quality=75&format=auto", title: 'Empower Your Brand', desc: 'Created to perfectly match your branding vision' },
          ...
          { img: "https://cricheroes-media-mumbai.s3.ap-south-1.amazonaws.com/server_images/your_web_landing/media-releases-and-news-updated.png?width=750&quality=75&format=auto", title: 'News & Announcements', desc: 'Keep your audience informed with the latest updates and events', reverse: true }].map((section, idx) => (
          <div
            key={idx}
      ...
      <div className="flex flex-col bg-[#14212A] w-full h-auto py-8 md:py-6 justify-center items-center gap-4">
          ...
          <button className="bg-[#4A2EB0] text-white px-3 py-2 md:px-4 md:py-2 rounded-md w-[120px] md:w-[150px]">
            Contact Us
          </button>
        </div>
