...
const handleSubmit = async (e) => {
    ...
    try {
        if (loginformdata) {
            await axios.post(`https://criclogbackendtest01.vercel.app/v1/signin`, formdata)
                .then((res) => {
            ...
            await axios.post("https://criclogbackendtest01.vercel.app/v1/signup", formdata)
                .then((res) => {
                    toast.success(res.data.message)
                    Setform(initial)
...
return (
<div className='w-full min-h-[100vh] bg-[#4D28D4] flex font-serif ' >
{loginformdata ? 
(<div className='lg:w-[50%] w-[100%] mx-[25px] lg:mt-[0px] lg:mx-[0px] mt-[40px] min-h-[100vh] bg-[white] flex flex-col justify-center items-center gap-[35px] py-[20px] lg:rounded-r-[15px] rounded-t-[15px]'>
    ...
    <form 
    onSubmit={handleSubmit} className="flex flex-col  gap-[20px] px-[10px] ">
        <div>
...
export const Otpverify=({handleotpclose})=>{
    ...
    const handleOTP = async (e) => {
        ...
        try {
                ...
                await axios.put(`https://criclogbackendtest01.vercel.app/v1/sendOTP`, sendotp)
                    .then((res) => {
                        toast.success(res.data.message)                
    ...
    const handleOTPVerify = async (e) => {
        ...
        try {
                ...
                await axios.post(`https://criclogbackendtest01.vercel.app/v1/VerifyOTP`, verifyotp)
                    .then((res) => {
                        toast.success(res.data.message)
